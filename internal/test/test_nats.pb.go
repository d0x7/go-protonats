...
// Versions:
// - protoc-gen-go-nats v0.1.12-dev.2+dirty
// - protoc        v5.29.3
// source: test.proto
...
type TestServiceNATSClient interface {
	...
	// Special cases
	ThreeSecondDelay(opts ...go_nats.CallOption) error
...
func (c *testServiceNATSClient) Ping(opts ...go_nats.CallOption) ([]*go_nats.Ping, error) {
	objs, _, err := request(c.nc, c.timeout, "$SRV.PING.TestService", nil, func(data []byte, rtt time.Duration) (*go_nats.Ping, error) {
...
func request[T any](conn *nats_go.Conn, timeout time.Duration, subject string, data []byte, collector func([]byte, time.Duration) (*T, error), opts ...go_nats.CallOption) ([]*T, []go_nats.ServiceError, error) {
	options := impl.ProcessCallOptions(opts...)
...
func (c *testServiceNATSClient) ThreeSecondDelay(opts ...go_nats.CallOption) error {
