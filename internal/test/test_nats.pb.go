...
// Versions:
// - protoc-gen-go-nats v0.1.11-dev.1+dirty
// - protoc        v5.29.3
// source: test.proto
...
func (c *testServiceNATSClient) Stats(opts ...go_nats.CallOption) ([]*micro.Stats, error) {
	...
	subject := options.Subject("$SRV.STATS.TestService")
...
func (c *testServiceNATSClient) Info(opts ...go_nats.CallOption) ([]*micro.Info, error) {
	...
	subject := options.Subject("$SRV.INFO.TestService")
...
func (c *testServiceNATSClient) Ping(opts ...go_nats.CallOption) ([]*go_nats.Ping, error) {
	...
	subject := options.Subject("$SRV.PING.TestService")
...
func (c *testServiceNATSClient) handleWithRetry(req proto.Message, subject string, out proto.Message, opts ...go_nats.CallOption) (err error) {
	...
	var tries int
	for {
		err = c.handle(req, options.Subject(subject), out, timeout)
...
func (c *testServiceNATSClient) ErrServiceErrorBroadcast(req *Test, opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, options.DisableFinisher, options.Subject("service.TestService.ErrServiceErrorBroadcast"), data, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
...
func (c *testServiceNATSClient) ErrServerErrorBroadcast(req *Test, opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, options.DisableFinisher, options.Subject("service.TestService.ErrServerErrorBroadcast"), data, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
		if err := proto.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) NormalBroadcastTestTest(req *Test, opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, options.DisableFinisher, options.Subject("service.TestService.NormalBroadcastTestTest"), data, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
		if err := proto.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) NormalBroadcastEmptyTest(opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, options.DisableFinisher, options.Subject("service.TestService.NormalBroadcastEmptyTest"), nil, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
		if err := proto.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) NormalBroadcastTestEmpty(req *Test, opts ...go_nats.CallOption) ([]go_nats.ServiceError, error) {
	...
	_, serviceErrs, err := request[struct{}](c.nc, timeout, options.DisableFinisher, options.Subject("service.TestService.NormalBroadcastTestEmpty"), data, nil)
...
func (c *testServiceNATSClient) NormalBroadcastEmptyEmpty(opts ...go_nats.CallOption) ([]go_nats.ServiceError, error) {
	...
	_, serviceErrs, err := request[struct{}](c.nc, timeout, options.DisableFinisher, options.Subject("service.TestService.NormalBroadcastEmptyEmpty"), nil, nil)
	return serviceErrs, err
}
...
func (c *testServiceNATSClient) LeaderOnlyBroadcastTestTest(req *Test, opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, options.DisableFinisher, options.Subject("service.TestService.LeaderOnlyBroadcastTestTest"), data, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
		if err := proto.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) LeaderOnlyBroadcastEmptyTest(opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, options.DisableFinisher, options.Subject("service.TestService.LeaderOnlyBroadcastEmptyTest"), nil, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
		if err := proto.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) LeaderOnlyBroadcastTestEmpty(req *Test, opts ...go_nats.CallOption) ([]go_nats.ServiceError, error) {
	...
	_, serviceErrs, err := request[struct{}](c.nc, timeout, options.DisableFinisher, options.Subject("service.TestService.LeaderOnlyBroadcastTestEmpty"), data, nil)
	return serviceErrs, err
}
...
func (c *testServiceNATSClient) LeaderOnlyBroadcastEmptyEmpty(opts ...go_nats.CallOption) ([]go_nats.ServiceError, error) {
	...
	_, serviceErrs, err := request[struct{}](c.nc, timeout, options.DisableFinisher, options.Subject("service.TestService.LeaderOnlyBroadcastEmptyEmpty"), nil, nil)
	return serviceErrs, err
}
...
func (c *testServiceNATSClient) FollowerOnlyBroadcastTestTest(req *Test, opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, options.DisableFinisher, options.Subject("service.TestService.FollowerOnlyBroadcastTestTest"), data, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
		if err := proto.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) FollowerOnlyBroadcastEmptyTest(opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, options.DisableFinisher, options.Subject("service.TestService.FollowerOnlyBroadcastEmptyTest"), nil, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
		if err := proto.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) FollowerOnlyBroadcastTestEmpty(req *Test, opts ...go_nats.CallOption) ([]go_nats.ServiceError, error) {
	...
	_, serviceErrs, err := request[struct{}](c.nc, timeout, options.DisableFinisher, options.Subject("service.TestService.FollowerOnlyBroadcastTestEmpty"), data, nil)
	return serviceErrs, err
}
...
func (c *testServiceNATSClient) FollowerOnlyBroadcastEmptyEmpty(opts ...go_nats.CallOption) ([]go_nats.ServiceError, error) {
	...
	_, serviceErrs, err := request[struct{}](c.nc, timeout, options.DisableFinisher, options.Subject("service.TestService.FollowerOnlyBroadcastEmptyEmpty"), nil, nil)
	return serviceErrs, err
}
