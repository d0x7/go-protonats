...
// Versions:
// - protoc-gen-go-nats v0.1.8-dev.3+dirty
// - protoc        v5.29.3
// source: test.proto
...
type TestServiceNATSClient interface {
	...
	// Methods that will error in the test implementation
...
func (c *testServiceNATSClient) Stats(opts ...go_nats.CallOption) ([]*micro.Stats, error) {
	...
	objs, _, err := request(c.nc, timeout, subject, nil, func(data []byte, rtt time.Duration) (*micro.Stats, error) {
		var obj micro.Stats
...
func (c *testServiceNATSClient) Info(opts ...go_nats.CallOption) ([]*micro.Info, error) {
	...
	objs, _, err := request(c.nc, timeout, subject, nil, func(data []byte, rtt time.Duration) (*micro.Info, error) {
		var obj micro.Info
		if err := json.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) Ping(opts ...go_nats.CallOption) ([]*go_nats.Ping, error) {
	...
	objs, _, err := request(c.nc, timeout, subject, nil, func(data []byte, rtt time.Duration) (*go_nats.Ping, error) {
...
func request[T any](conn *nats_go.Conn, timeout time.Duration, subject string, data []byte, collector func([]byte, time.Duration) (*T, error)) ([]*T, []go_nats.ServiceError, error) {
	ctx, cancel := context.WithTimeout(context.Background(), timeout)
	defer cancel()

	timer := time.NewTimer(timeout)
	go func() {
		// Select whatever happens first
		select {
		// if timer runs out first, cancel the 5 second context
		case <-timer.C:
			cancel()
		// if context is done already, do nothing, maybe stop timer
		case <-ctx.Done():
			timer.Stop()
			return
		}
...
func (c *testServiceNATSClient) ErrServiceErrorBroadcast(req *Test, opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, "service.TestService.ErrServiceErrorBroadcast", data, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
...
func (c *testServiceNATSClient) ErrServerErrorBroadcast(req *Test, opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, "service.TestService.ErrServerErrorBroadcast", data, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
		if err := proto.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) NormalBroadcastTestTest(req *Test, opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, "service.TestService.NormalBroadcastTestTest", data, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
		if err := proto.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) NormalBroadcastEmptyTest(opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, "service.TestService.NormalBroadcastEmptyTest", nil, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
		if err := proto.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) NormalBroadcastTestEmpty(req *Test, opts ...go_nats.CallOption) ([]go_nats.ServiceError, error) {
	...
	_, serviceErrs, err := request[struct{}](c.nc, timeout, "service.TestService.NormalBroadcastTestEmpty", data, nil)
...
func (c *testServiceNATSClient) NormalBroadcastEmptyEmpty(opts ...go_nats.CallOption) ([]go_nats.ServiceError, error) {
	...
	_, serviceErrs, err := request[struct{}](c.nc, timeout, "service.TestService.NormalBroadcastEmptyEmpty", nil, nil)
	return serviceErrs, err
}
...
func (c *testServiceNATSClient) LeaderOnlyBroadcastTestTest(req *Test, opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, "service.TestService.LeaderOnlyBroadcastTestTest", data, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
		if err := proto.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) LeaderOnlyBroadcastEmptyTest(opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, "service.TestService.LeaderOnlyBroadcastEmptyTest", nil, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
		if err := proto.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) LeaderOnlyBroadcastTestEmpty(req *Test, opts ...go_nats.CallOption) ([]go_nats.ServiceError, error) {
	...
	_, serviceErrs, err := request[struct{}](c.nc, timeout, "service.TestService.LeaderOnlyBroadcastTestEmpty", data, nil)
	return serviceErrs, err
}
...
func (c *testServiceNATSClient) LeaderOnlyBroadcastEmptyEmpty(opts ...go_nats.CallOption) ([]go_nats.ServiceError, error) {
	...
	_, serviceErrs, err := request[struct{}](c.nc, timeout, "service.TestService.LeaderOnlyBroadcastEmptyEmpty", nil, nil)
	return serviceErrs, err
}
...
func (c *testServiceNATSClient) FollowerOnlyBroadcastTestTest(req *Test, opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, "service.TestService.FollowerOnlyBroadcastTestTest", data, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
		if err := proto.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) FollowerOnlyBroadcastEmptyTest(opts ...go_nats.CallOption) ([]*Test, []go_nats.ServiceError, error) {
	...
	objs, serviceErrs, err := request(c.nc, timeout, "service.TestService.FollowerOnlyBroadcastEmptyTest", nil, func(data []byte, rtt time.Duration) (*Test, error) {
		var obj Test
		if err := proto.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) FollowerOnlyBroadcastTestEmpty(req *Test, opts ...go_nats.CallOption) ([]go_nats.ServiceError, error) {
	...
	_, serviceErrs, err := request[struct{}](c.nc, timeout, "service.TestService.FollowerOnlyBroadcastTestEmpty", data, nil)
	return serviceErrs, err
}
...
func (c *testServiceNATSClient) FollowerOnlyBroadcastEmptyEmpty(opts ...go_nats.CallOption) ([]go_nats.ServiceError, error) {
	...
	_, serviceErrs, err := request[struct{}](c.nc, timeout, "service.TestService.FollowerOnlyBroadcastEmptyEmpty", nil, nil)
	return serviceErrs, err
}
