...
// Versions:
// - protoc-gen-go-nats v0.1.12-dev.3+dirty
// - protoc        v5.29.3
// source: test.proto
...
import (
	...
	sync "sync"
	time "time"
	go_protonats "xiam.li/go-protonats"
	impl "xiam.li/go-protonats/impl"
)

// region Client
type TestServiceNATSClient interface {
	// Normal tests
	NormalTestTest(req *Test, opts ...go_protonats.CallOption) (*Test, error)
	NormalEmptyTest(opts ...go_protonats.CallOption) (*Test, error)
	NormalTestEmpty(req *Test, opts ...go_protonats.CallOption) error
	NormalEmptyEmpty(opts ...go_protonats.CallOption) error
	// Methods that will expect an error in the test implementation
	ErrServiceError(req *Test, opts ...go_protonats.CallOption) (*Test, error)
	ErrServerError(req *Test, opts ...go_protonats.CallOption) (*Test, error)
	ErrServiceErrorBroadcast(req *Test, opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error)
	ErrServerErrorBroadcast(req *Test, opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error)
	// Normal tests with broadcast option
	NormalBroadcastTestTest(req *Test, opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error)
	NormalBroadcastEmptyTest(opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error)
	NormalBroadcastTestEmpty(req *Test, opts ...go_protonats.CallOption) ([]go_protonats.ServiceError, error)
	NormalBroadcastEmptyEmpty(opts ...go_protonats.CallOption) ([]go_protonats.ServiceError, error)
	// Leader option tests
	LeaderOnlyTestTest(req *Test, opts ...go_protonats.CallOption) (*Test, error)
	LeaderOnlyEmptyTest(opts ...go_protonats.CallOption) (*Test, error)
	LeaderOnlyTestEmpty(req *Test, opts ...go_protonats.CallOption) error
	LeaderOnlyEmptyEmpty(opts ...go_protonats.CallOption) error
	// Leader with broadcast option tests
	LeaderOnlyBroadcastTestTest(req *Test, opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error)
	LeaderOnlyBroadcastEmptyTest(opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error)
	LeaderOnlyBroadcastTestEmpty(req *Test, opts ...go_protonats.CallOption) ([]go_protonats.ServiceError, error)
	LeaderOnlyBroadcastEmptyEmpty(opts ...go_protonats.CallOption) ([]go_protonats.ServiceError, error)
	// Follower option tests
	FollowerOnlyTestTest(req *Test, opts ...go_protonats.CallOption) (*Test, error)
	FollowerOnlyEmptyTest(opts ...go_protonats.CallOption) (*Test, error)
	FollowerOnlyTestEmpty(req *Test, opts ...go_protonats.CallOption) error
	FollowerOnlyEmptyEmpty(opts ...go_protonats.CallOption) error
	// Follower with broadcast option tests
	FollowerOnlyBroadcastTestTest(req *Test, opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error)
	FollowerOnlyBroadcastEmptyTest(opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error)
	FollowerOnlyBroadcastTestEmpty(req *Test, opts ...go_protonats.CallOption) ([]go_protonats.ServiceError, error)
	FollowerOnlyBroadcastEmptyEmpty(opts ...go_protonats.CallOption) ([]go_protonats.ServiceError, error)
	// Special cases
	ThreeSecondDelay(opts ...go_protonats.CallOption) error
	SetTimeout(time.Duration)
	// ListInstances returns a list containing all instances of this service
	// This is a convenience method that calls go_protonats.Ping with no options
	ListInstances() ([]*go_protonats.Ping, error)
	// Ping sends a ping to either all instances or a specific instance of this service
	Ping(opts ...go_protonats.CallOption) ([]*go_protonats.Ping, error)
	// Stats returns the stats of either all instances or a specific instance of this service
	Stats(opts ...go_protonats.CallOption) ([]*micro.Stats, error)
	// Info returns the info of either all instances or a specific instance of this service
	Info(opts ...go_protonats.CallOption) ([]*micro.Info, error)
}
...
func (c *testServiceNATSClient) ListInstances() ([]*go_protonats.Ping, error) {
	return c.Ping()
}

func (c *testServiceNATSClient) Stats(opts ...go_protonats.CallOption) ([]*micro.Stats, error) {
	objs, _, err := request(c.nc, c.timeout, "$SRV.STATS.TestService", nil, func(data []byte, rtt time.Duration) (*micro.Stats, error) {
		var obj micro.Stats
...
func (c *testServiceNATSClient) Info(opts ...go_protonats.CallOption) ([]*micro.Info, error) {
	objs, _, err := request(c.nc, c.timeout, "$SRV.INFO.TestService", nil, func(data []byte, rtt time.Duration) (*micro.Info, error) {
		var obj micro.Info
		if err := json.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
...
func (c *testServiceNATSClient) Ping(opts ...go_protonats.CallOption) ([]*go_protonats.Ping, error) {
	objs, _, err := request(c.nc, c.timeout, "$SRV.PING.TestService", nil, func(data []byte, rtt time.Duration) (*go_protonats.Ping, error) {
		var obj go_protonats.Ping
		if err := json.Unmarshal(data, &obj); err != nil {
			return nil, err
		}
		obj.RTT = rtt
...
func (c *testServiceNATSClient) handleWithRetry(req proto.Message, subject string, out proto.Message, opts ...go_protonats.CallOption) (err error) {
...
func (c *testServiceNATSClient) handle(ctx context.Context, req proto.Message, subject string, out proto.Message, timeout time.Duration) (err error) {
	var data []byte
	if req != nil {
		if data, err = proto.Marshal(req); err != nil {
			return go_protonats.ErrMarshallingFailed
		}
	}
	var msg *nats_go.Msg
	if ctx == nil {
	...
	if errMsg, errCode := msg.Header.Get(micro.ErrorHeader), msg.Header.Get(micro.ErrorCodeHeader); len(errMsg) > 0 && len(errCode) > 0 {
		if len(msg.Data) == 0 {
			return go_protonats.ServiceError{errCode, errMsg, ""}
		}
		return go_protonats.ServiceError{errCode, errMsg, string(msg.Data)}
	}
	if out != nil {
		if err = proto.Unmarshal(msg.Data, out); err != nil {
			return go_protonats.ErrUnmarshallingFailed
		}
	}
	return nil
}

func request[T any](conn *nats_go.Conn, timeout time.Duration, subject string, data []byte, collector func([]byte, time.Duration) (*T, error), opts ...go_protonats.CallOption) ([]*T, []go_protonats.ServiceError, error) {
	options := impl.ProcessCallOptions(opts...)
	...
	serviceErrs := []go_protonats.ServiceError{}
	...
	sub, err := conn.Subscribe(conn.NewRespInbox(), func(msg *nats_go.Msg) {
		...
		if errMsg, errCode := msg.Header.Get(micro.ErrorHeader), msg.Header.Get(micro.ErrorCodeHeader); len(errMsg) > 0 && len(errCode) > 0 {
			if len(msg.Data) == 0 {
				serviceErrs = append(serviceErrs, go_protonats.ServiceError{Code: errCode, Description: errMsg})
			} else {
				serviceErrs = append(serviceErrs, go_protonats.ServiceError{Code: errCode, Description: errMsg, Details: string(msg.Data)})
			}
			return
		}
		if collector != nil {
...
func (c *testServiceNATSClient) NormalTestTest(req *Test, opts ...go_protonats.CallOption) (*Test, error) {
	var response Test
...
func (c *testServiceNATSClient) NormalEmptyTest(opts ...go_protonats.CallOption) (*Test, error) {
	var response Test
...
func (c *testServiceNATSClient) NormalTestEmpty(req *Test, opts ...go_protonats.CallOption) error {
...
func (c *testServiceNATSClient) NormalEmptyEmpty(opts ...go_protonats.CallOption) error {
...
func (c *testServiceNATSClient) ErrServiceError(req *Test, opts ...go_protonats.CallOption) (*Test, error) {
	var response Test
...
func (c *testServiceNATSClient) ErrServerError(req *Test, opts ...go_protonats.CallOption) (*Test, error) {
	var response Test
...
func (c *testServiceNATSClient) ErrServiceErrorBroadcast(req *Test, opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error) {
	var data []byte
	if req != nil {
		var err error
		if data, err = proto.Marshal(req); err != nil {
			return nil, nil, go_protonats.ErrMarshallingFailed
		}
	}
...
func (c *testServiceNATSClient) ErrServerErrorBroadcast(req *Test, opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error) {
	var data []byte
	if req != nil {
		var err error
		if data, err = proto.Marshal(req); err != nil {
...
func (c *testServiceNATSClient) NormalBroadcastTestTest(req *Test, opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error) {
	var data []byte
	if req != nil {
		var err error
		if data, err = proto.Marshal(req); err != nil {
...
func (c *testServiceNATSClient) NormalBroadcastEmptyTest(opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error) {
...
func (c *testServiceNATSClient) NormalBroadcastTestEmpty(req *Test, opts ...go_protonats.CallOption) ([]go_protonats.ServiceError, error) {
	var data []byte
	if req != nil {
		var err error
		if data, err = proto.Marshal(req); err != nil {
			return nil, go_protonats.ErrMarshallingFailed
		}
	}
...
func (c *testServiceNATSClient) NormalBroadcastEmptyEmpty(opts ...go_protonats.CallOption) ([]go_protonats.ServiceError, error) {
	_, serviceErrs, err := request[struct{}](c.nc, c.timeout, "service.TestService.NormalBroadcastEmptyEmpty", nil, nil, opts...)
	return serviceErrs, err
}

func (c *testServiceNATSClient) LeaderOnlyTestTest(req *Test, opts ...go_protonats.CallOption) (*Test, error) {
	var response Test
...
func (c *testServiceNATSClient) LeaderOnlyEmptyTest(opts ...go_protonats.CallOption) (*Test, error) {
	var response Test
...
func (c *testServiceNATSClient) LeaderOnlyTestEmpty(req *Test, opts ...go_protonats.CallOption) error {
...
func (c *testServiceNATSClient) LeaderOnlyEmptyEmpty(opts ...go_protonats.CallOption) error {
...
func (c *testServiceNATSClient) LeaderOnlyBroadcastTestTest(req *Test, opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error) {
	var data []byte
	if req != nil {
		var err error
		if data, err = proto.Marshal(req); err != nil {
...
func (c *testServiceNATSClient) LeaderOnlyBroadcastEmptyTest(opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error) {
...
func (c *testServiceNATSClient) LeaderOnlyBroadcastTestEmpty(req *Test, opts ...go_protonats.CallOption) ([]go_protonats.ServiceError, error) {
	var data []byte
	if req != nil {
		var err error
		if data, err = proto.Marshal(req); err != nil {
...
func (c *testServiceNATSClient) LeaderOnlyBroadcastEmptyEmpty(opts ...go_protonats.CallOption) ([]go_protonats.ServiceError, error) {
	_, serviceErrs, err := request[struct{}](c.nc, c.timeout, "service.TestService.LeaderOnlyBroadcastEmptyEmpty", nil, nil, opts...)
	return serviceErrs, err
}

func (c *testServiceNATSClient) FollowerOnlyTestTest(req *Test, opts ...go_protonats.CallOption) (*Test, error) {
	var response Test
...
func (c *testServiceNATSClient) FollowerOnlyEmptyTest(opts ...go_protonats.CallOption) (*Test, error) {
	var response Test
...
func (c *testServiceNATSClient) FollowerOnlyTestEmpty(req *Test, opts ...go_protonats.CallOption) error {
...
func (c *testServiceNATSClient) FollowerOnlyEmptyEmpty(opts ...go_protonats.CallOption) error {
...
func (c *testServiceNATSClient) FollowerOnlyBroadcastTestTest(req *Test, opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error) {
	var data []byte
	if req != nil {
		var err error
		if data, err = proto.Marshal(req); err != nil {
...
func (c *testServiceNATSClient) FollowerOnlyBroadcastEmptyTest(opts ...go_protonats.CallOption) ([]*Test, []go_protonats.ServiceError, error) {
...
func (c *testServiceNATSClient) FollowerOnlyBroadcastTestEmpty(req *Test, opts ...go_protonats.CallOption) ([]go_protonats.ServiceError, error) {
	var data []byte
	if req != nil {
		var err error
		if data, err = proto.Marshal(req); err != nil {
...
func (c *testServiceNATSClient) FollowerOnlyBroadcastEmptyEmpty(opts ...go_protonats.CallOption) ([]go_protonats.ServiceError, error) {
	_, serviceErrs, err := request[struct{}](c.nc, c.timeout, "service.TestService.FollowerOnlyBroadcastEmptyEmpty", nil, nil, opts...)
	return serviceErrs, err
}

func (c *testServiceNATSClient) ThreeSecondDelay(opts ...go_protonats.CallOption) error {
	if err := c.handleWithRetry(nil, "service.TestService.ThreeSecondDelay", nil, opts...); err != nil {
		return err
	}
	return nil
}
...
func NewTestServiceNATSServer(nc *nats_go.Conn, server TestServiceNATSServer, opts ...go_protonats.ServerOption) micro.Service {
...
func NewTestServiceNATSLeaderServer(nc *nats_go.Conn, server TestServiceNATSLeaderServer, opts ...go_protonats.ServerOption) micro.Service {
	service, options, err := impl.NewService("TestService", nc, server, opts...)
	if err != nil {
		panic(err) // TODO: Update this to proper error handling
	}
...
func NewTestServiceNATSFollowerServer(nc *nats_go.Conn, server TestServiceNATSFollowerServer, opts ...go_protonats.ServerOption) micro.Service {
	service, options, err := impl.NewService("TestService", nc, server, opts...)
	if err != nil {
		panic(err) // TODO: Update this to proper error handling
	}
